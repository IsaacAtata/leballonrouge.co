...
if (typeof window.__legacyLoaded === "undefined") {
  ...
  /* -----------------------------
     Language switcher — preserve page + scroll section
  ----------------------------- */
  function initLangSwitcher() {
    const frLink = document.getElementById("lang-opt-fr");
    const enLink = document.getElementById("lang-opt-en");
    ...
    function updateLinks() {
      if (frLink) frLink.href = getEquivalentUrl("fr");
      if (enLink) enLink.href = getEquivalentUrl("en");
    }
    ...
    const activeLink  = currentLang === "en" ? enLink : frLink;
